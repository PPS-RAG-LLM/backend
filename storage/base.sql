...
VALUES 
    (
        1,'admin','pps_admin','이용범','AI 연구소','팀장', NULL,'',NULL,0,3,
        '2025-08-14 15:11:42','2025-08-14 15:11:42', NULL
    ),
    (
        2,'user','ruah0807','김루아','AI 연구소','연구원',NULL,'',NULL,0,3,
        '2025-08-13 13:54:54','2025-08-13 13:54:54', NULL
    ),
     (
        3,'user','rlwjd123','조기정','AI 연구소','선임 연구원',NULL,'',NULL,0,3,
        '2025-08-14 15:06:03','2025-08-14 15:06:03', NULL
    ),
    (
        4,'user','mingue123','강민규','AI 연구소','연구원',NULL,'',NULL,0,2,
        '2025-08-14 15:10:22','2025-08-14 15:10:22', NULL
    ),
    (
        5,'user','iju1234','마주이','AI 연구소','선임 연구원',NULL,'',NULL,0,1,
