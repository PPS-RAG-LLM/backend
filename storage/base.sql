...
VALUES
    (201,'text', 'false', '출장제목', NULL,'출장 문서의 제목'),
    (202,'datetime', 'true', '출장시작일', NULL,'출장 시작일과 종료일'),
    (203,'datetime', 'true', '출장종료일', NULL,'출장 시작일과 종료일'),
    (204,'text', 'false', '출장목적',NULL,'출장의 목적 및 기대 효과'),
    (205,'text', 'false', '주요일정',NULL,'주요 일정 요약'),
    (206,'text', 'false', '준비물',NULL,'준비해야 할 물품 목록'),
    (207,'text', 'false', '결재자',NULL,'결재를 맡은 책임자'),
    (208,'text', 'false', '회의명',NULL,'회의의 제목 또는 안건'),
    (209,'datetime', 'true', '회의일시',NULL,'회의가 진행된 일시'),
    (210,'text', 'false', '참석자',NULL,'참석자 명단'),
    (211,'text', 'false', '주요논의',NULL,'핵심 논의 내용 요약'),
    (212,'text', 'false', '결정사항',NULL,'회의에서 확정된 결정 사항'),
    (213,'text', 'false', '후속조치',NULL,'회의 후 수행해야 할 조치'),
    (214,'text', 'false', '발표자료',NULL,'공유된 발표 자료 목록'),
    (215,'text', 'false', '참고자료',NULL,'회의 참고 자료'),
    (216,'text', 'false', '담당자',NULL,'후속 조치 담당자'),
    (217,'text', 'false', '보고제목',NULL,'보고서 제목'),
    (218,'text', 'false', '보고기간',NULL,'보고 대상 기간'),
    (219,'text', 'false', '성과요약',NULL,'핵심 성과 요약'),
    (220,'text', 'false', '주요지표',NULL,'성과를 보여주는 주요 지표'),
    (221,'text', 'false', '리스크',NULL,'인식된 리스크 요약'),
    (222,'text', 'false', '대응방안',NULL,'리스크 대응 계획'),
    (223,'text', 'false', '이슈',NULL,'발생한 주요 이슈'),
    (224,'text', 'false', '요청사항',NULL,'추가 요청 또는 필요 지원'),
    (225,'text', 'false', '작성부서',NULL,'보고서를 작성한 부서');
...
VALUES
    ...
    (321,106,218,'2025-09-01 09:25:00','2025-09-01 09:25:00'),
    (322,106,219,'2025-09-01 09:25:00','2025-09-01 09:25:00'),
    (323,107,216,'2025-09-01 09:30:00','2025-09-01 09:30:00'),
    (324,107,220,'2025-09-01 09:30:00','2025-09-01 09:30:00'),
    (325,107,221,'2025-09-01 09:30:00','2025-09-01 09:30:00'),
    (326,108,216,'2025-09-01 09:35:00','2025-09-01 09:35:00'),
    (327,108,222,'2025-09-01 09:35:00','2025-09-01 09:35:00'),
    (328,108,223,'2025-09-01 09:35:00','2025-09-01 09:35:00'),
    (329,108,224,'2025-09-01 09:35:00','2025-09-01 09:35:00'),
    (330,108,225,'2025-09-01 09:35:00','2025-09-01 09:35:00');
