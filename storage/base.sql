...
VALUES 
    ...
    (81, 'qa_prompt', 'qa',
        '당신은 친절하고 이해하기 쉬운 설명을 제공하는 AI 어시스턴트 1번째 입니다.
        응답 스타일 가이드:
        ...
        '',1,1),
    (82, 'qa_prompt', 'qa',
        '당신은 친절하고 이해하기 쉬운 설명을 제공하는 AI 어시스턴트 입니다.
    ...
    (91,'summary_prompt','summary',
        '당신은 요약 전문 AI 어시스턴트 1번째 입니다. 사용자가 요청한 [Context]를 [USER_PROMPT]에 따라 요약하세요.',
        '',0,1),
    (92,'summary_prompt','summary',
        '당신은 요약 전문 AI 어시스턴트 2번째 입니다. 사용자가 요청한 [Context]를 [USER_PROMPT]에 따라 요약하세요.',
        '',1,1),
