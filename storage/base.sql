...
INSERT INTO
    "users" (
        "id","role","username","name", "department","position",
...
VALUES 
    ...
    (
        2,'admin','pps_admin2','이용범2','AI 연구소','팀장', NULL,'',NULL,0,3,
        '2025-08-14 15:11:42','2025-08-14 15:11:42', NULL
    ),
    (
        3,'admin','pps_admin3','이용범3','AI 연구소','팀장', NULL,'',NULL,0,3,
        '2025-08-14 15:11:42','2025-08-14 15:11:42', NULL
    ),
    (
        4,'user','ruah0807','김루아','AI 연구소','연구원',NULL,'',NULL,0,3,
        '2025-08-13 13:54:54','2025-08-13 13:54:54', NULL
    ),
    (
        5,'user','rlwjd123','조기정','AI 연구소','선임 연구원',NULL,'',NULL,0,3,
        '2025-08-14 15:06:03','2025-08-14 15:06:03', NULL
    ),
    (
        6,'user','mingue123','강민규','AI 연구소','연구원',NULL,'',NULL,0,2,
        '2025-08-14 15:10:22','2025-08-14 15:10:22', NULL
    ),
    (
        7,'user','iju1234','마주이','AI 연구소','선임 연구원',NULL,'',NULL,0,1,
        '2025-08-14 15:12:03','2025-08-14 06:12:03','2025-11-30 06:12:03'
    );
    
-- password : Nullable 로 NIQ 내에서 직접 로그인도 가능한 시스템 처리
