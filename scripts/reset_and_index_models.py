...
2) (Optional) Scan filesystem under STORAGE_ROOT (default: backend/storage/models/llm):
...
Environment variables:
  ...
  STORAGE_MODEL_ROOT: path to model storage (defaults to backend/storage/models/llm)
"""
...
STORAGE_MODEL_ROOT = os.getenv("STORAGE_MODEL_ROOT", str(_backend_root() / "storage" / "models" / "llm"))
